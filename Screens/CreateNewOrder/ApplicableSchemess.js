...
export default class ApplicableSchemess extends Component {
    constructor(props) {
        super(props);
        this.state = {  };
    }
    ...
    //  headerLeft: <Icon name='back-arrow' tintColor='white'
    //                         onPress={ () => { navigation.goBack() }} />,    
    }

    render() {
      // const={brandNameContainer}=styles
        return (
           <View style = {{ flex: 10 }}>
              <ScrollView
              ...
              >
                ...
                <View style={styles.appliSchemesMainContainer}>
                    <View style={styles.appliSchemesRowContainer}>
                          ...
                          <View style={styles.appliSchemesDownArrowContainer}>
                                    <TouchableOpacity  onPress={() => this.props.navigation.navigate('ApplicableSchemess')}>
                                        <Image style={styles.appliSchemesdownArrowStyle} 
...
const styles = StyleSheet.create({
  ...
  appliSchemesDownArrowContainer: { 
    flex:1, 
    alignItems: 'flex-end', 
    flexDirection:'row', 
