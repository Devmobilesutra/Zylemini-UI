    ...
    // />,
     headerRight: (
        <View style={{flexDirection:"row", alignItems:'center',justifyContent:'center',alignSelf:'center',}}>
            ...
            <TouchableOpacity  >  
                <Image    style={{marginRight:hp('4'), height:hp('3'), width:wp('4'), color:'#2FC36E',tintColor:'#2FC36E'}}
                    source = {require('../../Assets/Icons/Card_View.png')}
                />
            </TouchableOpacity>
            <TouchableOpacity  onPress={() =>Actions.Shops() }>
             <Image  style={{marginRight:hp('4'), height:hp('3'), width:wp('4'),color:'#8C7878', tintColor:'#8C7878'}}  
        ...
        >
            ...
            <View style= {styles.totalShopsMainContainer}>
                ...
                <View style= {styles.visitedColumnContainer}>
                    <Text  style = {styles.visitedCountTextStyle}>
                            10
                    </Text>
