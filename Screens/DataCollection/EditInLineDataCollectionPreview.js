...
export default class EditInLineDataCollectionPreview extends Component {
    constructor(props) {
        super(props);
        this.state = {  };
    }
    render() {
        ...
        return (
            ...
            {/* remarks  */}
            <View style={styles.remarkMainContainerStock}>
                <Text style={styles.remarkTextStyleStock}>
                    Remarks
                </Text>
            </View>
            <View style={styles.remarkTextInputMainContainerStock}> 
                <TextInput
                    //multiline= {}
                    style={styles.remarkTextInputStyleStock}
